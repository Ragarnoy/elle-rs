use crate::config::profile::{FlashRequest, FlashResponse};
...
pub struct SequentialFlashManager<'a> {
    flash: Flash<'a, FLASH, Async, { crate::config::profile::FLASH_SIZE }>,
    last_save_time: Option<Instant>,
    data_buffer: [u8; DATA_BUFFER_SIZE],
}

impl<'a> SequentialFlashManager<'a> {
    pub fn new(flash: Flash<'a, FLASH, Async, { crate::config::profile::FLASH_SIZE }>) -> Self {
        Self {
            flash,
            last_save_time: None,
